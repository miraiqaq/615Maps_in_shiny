...
server <- function(input, output,session) {
     ...
     if (input$var == "Democrats") {
       ...
       states_center$st <- states_center$D_st_abrev
      ...
      states_center$st <- states_center$R_st_abrev
      color_low <- "pink1"
      color_high <- "red4"
    ...
    p <- ggplot(data = states) + 
        ...
        geom_text(data = states_center,aes(x=long, y=lat, label = paste0(st,"\n",Donors)),size=2, color="white") +
